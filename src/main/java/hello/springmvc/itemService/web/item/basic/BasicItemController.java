...
public class BasicItemController {
    ...
    //@PostMapping("/add") addItemV2, 3, 4와 중복 매핑이라 주석 풀면 오류 발생
     ...
     */
    // @PostMapping("/add") addItemV1,3,4와 중복 매핑이라 주석 풀면 오류 발생
     ...
     */
    // @PostMapping("/add") addItemV1,2,4과 중복 매핑이라 주석 풀면 오류 발생
